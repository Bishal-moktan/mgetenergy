...
const Testinomials = () => {
  const testinomials = [
    ...
    {
        icon: <FaQuoteRight />,
        description: "We have 20 kw grid-tied solar power system installed by MAXOPTIMUS, 5 years back July 2016. System has been running since than with 100% uptime. One does not need to look further than MAXOPTIMUS for solar power system. Exceptional system integrator, system has delivered more than promised by MAXOPTIMUS.",
        name: "Dr Ritesh Garg",
    ...
    {
        icon: <FaQuoteRight />,
        description: "It's almost 5 years + years offgrid (battery backup) system installed by MAXOPTIMUS, since then I have never experienced electricity outage, solar power system has reduced electricity bill by almost 50%.",
    ...
    {
        icon: <FaQuoteRight />,
        description: "For farm house we had constructed in our village we had been scouting for solar power system, since in our area is troubled with frequent power cuts we did not wanted to have grid supply. We have offgrid system installed by MAXOPTIMUS, simple to use and maintain at very reasonable cost, providing sustainable source of energy.",
  ...
  return (
    <section className="testinomials__container">
      ...
      className="testinomials__container-content"
    >
            ...
            <SwiperSlide key={index}>
               <div className="info">
                <FaQuoteRight className="info-icon"/>
                <p>{description}</p>
                </div>
